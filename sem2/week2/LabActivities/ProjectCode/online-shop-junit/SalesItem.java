...
public class SalesItem
{
    ...
    // {
    //     SalesItem salesItem1 = new SalesItem("Shoes", -30);
    //     //SalesItem salesItem2 = new SalesItem("Watch", 70);
    //     salesItem1.addComment("Lizzy", "good stuff", 4);
    //     salesItem1.addComment("Lizzy", "wahoo", 3);
    //     salesItem1.addComment("Lyle", "Could be better", 0);
    //     salesItem1.addComment("Jace", "it's a slay", 5);
    //     salesItem1.removeComment(3);
    //     salesItem1.upvoteComment(2);
    
    //     salesItem1.showInfo();
    //     System.out.println(salesItem1.findMostHelpfulComment());
    
    //     // System.out.println("Item Name: " + salesItem1.getName() + " | " + "Item Price: " + salesItem1.getPrice());
    //     // System.out.println("Item Name: " + salesItem2.getName() + " | " + "Item Price: " + salesItem2.getPrice());
    // }
    /**
    ...
    {
        if(comments != null && index >=0 && index < comments.size()) { // if index is valid
     ...
     * them.
     */
    public String findMostHelpfulComment()
    {
