...
public class Car
{
    ...
    //Expressed as a whole number percentage, from 0% to 100%
    private int damageLevel;
       
    /**
     * Constructor for objects of class Car
     */
    public Car(String name, int currentFuelLevel, int damageLevel)
    {
       this.name = name;
     ...
     */
    public int completeLap(int externalRainSlowDown){
        ...
        //The number of seconds a car is slower per lap when it is raining
        int rainSlowDown = currentRace.isRaining() ? externalRainSlowDown : 0; 
        ...
        if (currentRace.isRaining()) 
        {
            singleLapTime += rainSlowDown;    
        }

        //TASK: if the damageLevel is greater than 50%, the lap time is doubled
        if (damageLevel > 50) 
        {
            singleLapTime = singleLapTime * 2;    
        }
