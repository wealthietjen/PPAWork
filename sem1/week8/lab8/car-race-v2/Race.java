...
public class Race
{
    ...
    int averageLapTime, boolean isRaining, RaceTrack raceTrack)
    {
        this.car1 = car1;
        this.car2 = car2;
        this.car3 = car3;
        this.numberOfLaps = numberOfLaps;
        this.raceTrack.setAverageLapTime(averageLapTime);
        this.raceTrack.setIsRaining(isRaining);
    }

    public static void main(String[] args) 
    {
        Car car1 = new Car("Car1", 50, 40);
        Car car2 = new Car("Car2", 90, 70);
        Car car3 = new Car("Car3", 80, 50);
        RaceTrack raceTrack = new RaceTrack();
        
        Race race1 = new Race(car1, car2, car3, 4, 5, false, raceTrack);
    ...
    {
        return raceTrack.getAverageLapTime();
    }

    public boolean isRaining()
    {
        return raceTrack.getIsRaining();
    }
    ...
    public Car getRaceLeader()
    {
        ...
        else if (car1.getTotalTime() == car2.getTotalTime() && car2.getTotalTime() == car3.getTotalTime()) 
        {
            raceLeader = null;
        }
    ...
    public void simulateRace()
    {
        ...
        {
            int lap1 = car1.completeLap(5);
            int lap2 = car2.completeLap(4);
            int lap3 = car3.completeLap(7);
